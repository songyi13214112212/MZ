...
GO
ALTER TABLE [dbo].[CRKDMX3] DROP CONSTRAINT [FK__CRKDMX3__F_SPBH__353DDB1D]
GO
ALTER TABLE [dbo].[CRKDMX2] DROP CONSTRAINT [FK__CRKDMX2__F_SPBH__32616E72]
GO
ALTER TABLE [dbo].[CRKDMX1] DROP CONSTRAINT [FK__CRKDMX1__F_SPBH__2F8501C7]
GO
ALTER TABLE [dbo].[CRKD3] DROP CONSTRAINT [FK__CRKD3__F_VENDOR__29CC2871]
GO
ALTER TABLE [dbo].[CRKD3] DROP CONSTRAINT [FK__CRKD3__F_PATIENT__2AC04CAA]
GO
ALTER TABLE [dbo].[CRKD3] DROP CONSTRAINT [FK__CRKD3__F_HW__28D80438]
GO
ALTER TABLE [dbo].[CRKD3] DROP CONSTRAINT [FK__CRKD3__F_DOCTOR__2CA8951C]
GO
ALTER TABLE [dbo].[CRKD3] DROP CONSTRAINT [FK__CRKD3__F_DEPART__2BB470E3]
GO
ALTER TABLE [dbo].[CRKD2] DROP CONSTRAINT [FK__CRKD2__F_VENDOR__231F2AE2]
GO
ALTER TABLE [dbo].[CRKD2] DROP CONSTRAINT [FK__CRKD2__F_PATIENT__24134F1B]
GO
ALTER TABLE [dbo].[CRKD2] DROP CONSTRAINT [FK__CRKD2__F_HW__222B06A9]
GO
ALTER TABLE [dbo].[CRKD2] DROP CONSTRAINT [FK__CRKD2__F_DOCTOR__25FB978D]
GO
ALTER TABLE [dbo].[CRKD2] DROP CONSTRAINT [FK__CRKD2__F_DEPART__25077354]
GO
ALTER TABLE [dbo].[CRKD1] DROP CONSTRAINT [FK__CRKD1__F_VENDOR__1C722D53]
GO
ALTER TABLE [dbo].[CRKD1] DROP CONSTRAINT [FK__CRKD1__F_PATIENT__1D66518C]
GO
ALTER TABLE [dbo].[CRKD1] DROP CONSTRAINT [FK__CRKD1__F_HW__1B7E091A]
GO
ALTER TABLE [dbo].[CRKD1] DROP CONSTRAINT [FK__CRKD1__F_DOCTOR__1F4E99FE]
GO
ALTER TABLE [dbo].[CRKD1] DROP CONSTRAINT [FK__CRKD1__F_DEPART__1E5A75C5]
GO
...
GO
ALTER TABLE [dbo].[DJH] DROP CONSTRAINT [DF__DJH__F_RETAIL__69C6B1F5]
GO
ALTER TABLE [dbo].[DJH] DROP CONSTRAINT [DF__DJH__F_RECIPE__68D28DBC]
GO
...
REFERENCES [dbo].[VENDOR] ([F_DM])
GO
ALTER TABLE [dbo].[CRKDMX1]  WITH CHECK ADD FOREIGN KEY([F_SPBH])
REFERENCES [dbo].[DRUG] ([F_SPBH])
GO
ALTER TABLE [dbo].[CRKDMX2]  WITH CHECK ADD FOREIGN KEY([F_SPBH])
REFERENCES [dbo].[DRUG] ([F_SPBH])
GO
ALTER TABLE [dbo].[CRKDMX3]  WITH CHECK ADD FOREIGN KEY([F_SPBH])
REFERENCES [dbo].[DRUG] ([F_SPBH])
GO
