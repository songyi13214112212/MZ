...
CREATE	TABLE	[处方类别]
(
	处方类别ID	VARCHAR(10)	NOT	NULL PRIMARY KEY,
	处方类别名称	VARCHAR(50)	 NOT	NULL,
)
CREATE	TABLE	[处方]
(
	单据号	INT		NOT	NULL PRIMARY KEY,
	日期	VARCHAR(10) DEFAULT CONVERT(VARCHAR(10),GETDATE(),120),
	时间	VARCHAR(10)	DEFAULT	CONVERT(VARCHAR(10),GETDATE(),108),
	处方类别ID	VARCHAR(10)	REFERENCES	[处方类别](处方类别ID),
	挂号单据号	INT			REFERENCES [挂号](单据号),
	患者		VARCHAR(20)	REFERENCES 病人(病人ID),
	类别ID		VARCHAR(10)	REFERENCES [挂号类别](类别ID) ,
	科室ID		VARCHAR(10)	REFERENCES [科室](科室ID) ,
	诊室ID		VARCHAR(10)	REFERENCES [诊室](诊室ID) ,
	职员ID		VARCHAR(10)	REFERENCES [职员](职员ID) ,
	职务ID		VARCHAR(10)	REFERENCES [职务](职务ID) ,
	制单		VARCHAR(20)	NOT	NULL,
)
