...
CREATE TABLE [DBO].[DJH](
	...
	[F_QDD]		[INT] NULL,
	[F_PDD]		[INT] NULL,
	[F_RECIPE]	[INT] DEFAULT 0,
	[F_RETAIL]	[INT] DEFAULT 0,	
	[F_XSBB]	[INT] NULL,
	[F_PC]		[INT] NULL,
	[F_JIEZ]	[INT] NULL,
